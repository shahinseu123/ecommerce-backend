                    ...
                    <form action="{{ route('admin.login.action') }}" method="POST">
                        ...
                        <div class="mt-3">
                            ...
                            <input required value="{{ old('email') }}" type="email" name="email" id="email"
                                class="w-full py-2 input-border rounded pl-2">
                            @error('email')
                        ...
                        <p class="mt-4">Not registered? <a class="text-blue-600"
                                href="{{ route('admin.register') }}">Register now</a></p>
                        <button type="submit"
                            class="px-10 py-3 rounded text-white btn_primary font-semibold text-sm mt-3">SUBMIT</button>
                    </form>
                </div>
            </div>
        </div>
