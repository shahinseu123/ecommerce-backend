...
@section('content')
    <section>
        ...
        <h1 class="text-3xl font-semibold uppercase text-gray-600">Admins</h1>
        @if ($admin)
                        ...
                        <div class="shadow-lg bg-white rounded p-4">
                            <div class="lg:grid xl:grid lg:grid-cols-3 xl:grid-cols-3 gap-3">
                                <div>
                                    ...
                                    <input type="text" name="name" value="{{$admin->name}}" required id="name" class="input-border rounded px-2 py-2 w-full mt-2">
                                    @error('name')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="email" value="{{$admin->email}}" required id="email" class="input-border rounded px-2 py-2 w-full mt-2">
                                    @error('email')
                                    <div class="text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="number" value="{{$admin->phone}}" name="phone" required id="phone" class="input-border rounded px-2 py-2 w-full mt-2">
                                    @error('phone')
                                    <div class="text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mt-2">
                                ...
                                <input type="text" name="street" value="{{$admin->street}}" required id="street" class="input-border rounded px-2 py-2 w-full mt-2">
                                @error('street')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="lg:grid xl:grid lg:grid-cols-4 xl:grid-cols-4 gap-3 mt-2">
                                <div>
                                    ...
                                    <input type="number" name="zip" value="{{$admin->zip}}" required id="zip" class="input-border rounded px-2 py-2 w-full mt-2">
                                    @error('zip')
                                    <div class="text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="city" value="{{$admin->city}}" required id="city" class="input-border rounded px-2 py-2 w-full mt-2">
                                    @error('city')
                                    <div class="text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="state" value="{{$admin->state}}" required id="state" class="input-border rounded px-2 py-2 w-full mt-2">
                                    @error('state')
                                    <div class="text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="country" value="{{$admin->country}}" required id="country" class="input-border rounded px-2 py-2 w-full mt-2">
                                    @error('country')
                                    <div class="text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="w-full sssss-nav pb-4 click_post_btn cursor-pointer">
                                ...
                                <div class="w-full sssss">
                                    <img class="w-full object-cover h-48 cursor-pointer" id="category-img-tag"
                                        src="{{$admin->img_path}}"
                                        alt="img">
                                    <input type="hidden" value="" name="user_image" id="news_img" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white shadow-lg rounded p-4 mb-4">
                            ...
                            <div class="border-t-2 border-gray-300">
                                <button class="w-full py-2 text-white  btn_secondary rounded shadow-lg mt-3 m" type="submit">UPADTE</button>
