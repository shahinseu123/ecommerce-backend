                    ...
                    <div class="shadow-lg bg-white rounded p-4">
                        <div class="lg:grid xl:grid lg:grid-cols-3 xl:grid-cols-3 gap-3">
                            <div>
                                ...
                                <input type="text" name="name" required id="name" class="input-border rounded px-2 py-2 w-full mt-2">
                                 @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="email" required id="email" class="input-border rounded px-2 py-2 w-full mt-2">
                                @error('email')
                                  <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" name="phone" required id="phone" class="input-border rounded px-2 py-2 w-full mt-2">
                                @error('phone')
                                  <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" name="street" required id="street" class="input-border rounded px-2 py-2 w-full mt-2">
                            @error('street')
                                  <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="lg:grid xl:grid lg:grid-cols-4 xl:grid-cols-4 gap-3 mt-2">
                            <div>
                                ...
                                <input type="number" name="zip" required id="zip" class="input-border rounded px-2 py-2 w-full mt-2">
                                @error('zip')
                                  <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="city" required id="city" class="input-border rounded px-2 py-2 w-full mt-2">
                                @error('city')
                                  <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="state" required id="state" class="input-border rounded px-2 py-2 w-full mt-2">
                                @error('state')
                                  <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="country" required id="country" class="input-border rounded px-2 py-2 w-full mt-2">
                                @error('country')
                                   <div class="text-red-500">{{ $message }}</div>
                                 @enderror
                            </div>
