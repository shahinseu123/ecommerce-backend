                        ...
                        <div class="bg-white shadow-lg rounded p-4">
                            <div class="mb-4">
                                ...
                                <input class="input-border rounded px-2 py-2 w-full mt-2" type="text" name="brand_title"
                                    id="brand_title" required value="{{ $brand->brand_title }}">
                                @error('brand_title')
                            ...
                            <div class="mb-4">
                                ...
                                <label for="brand_title_bd" class="font-semibold">Title in bangla<span
                                        class="text-red-500">*</span></label>
                                <input class="input-border rounded px-2 py-2 w-full mt-2" type="text" name="brand_title_bd"
                                    id="brand_title_bd" required value="{{ $brand->brand_title_bd }}">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="input-border rounded px-2 py-2 w-full mt-2" name="short_description"
                                    id="short_description" cols="30" rows="4">{{ $brand->short_description }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="input-border rounded px-2 py-2 w-full" style="margin-top: 10px;z-index: -1"
                                    name="brand_description" id="editor" cols="30"
                            ...
                            <div class="mb-4">
                                <label for="brand_description_bd" class="font-semibold">Description in bangla<span
                                        class="text-red-500">*</span></label>
                                <textarea class="input-border rounded px-2 py-2 w-full" style="margin-top: 10px;z-index: -1"
                                    name="brand_description_bd" id="editor_2" cols="30"
                                    rows="5">{{ $brand->brand_description_bd }}</textarea>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-2"
                                            value="{{ $brand->meta_title }}" name="meta_title" id="meta_title">
                                        @error('meta_title')
                                            <div class="text-red-500">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-2"
                                            value="{{ $brand->meta_description }}" name="meta_description"
                                            id="meta_description">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-2"
                                            value="{{ $brand->meta_tags }}" name="meta_tags" id="meta_tags">
                                        @error('meta_tags')
                                            <div class="text-red-500">{{ $message }}</div>
                                        @enderror
                                    </div>
