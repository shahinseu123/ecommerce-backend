            ...
            <div class="lg:w-2/3 xl:w-2/3">
                <div class="bg-white shadow-lg rounded p-4">
                    <div class="mb-4">
                        ...
                        <input class="input-border rounded px-2 py-2 w-full mt-2" type="text" name="brand_title" id="brand_title" required value="{{old('brand_title')}}">
                        @error('brand_title')
                    ...
                    <div class="mb-4">
                         ...
                         <textarea class="input-border rounded px-2 py-2 w-full" style="margin-top: 10px;z-index: -1" name="brand_description" id="editor" cols="30" rows="5"></textarea>
