            ...
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                <thead>
                    <tr>
                        ...
                        <th class="text-left" data-priority="2">Coupon</th>
                        <th class="text-left" data-priority="2">Discount type</th>
                        <th class="text-left" data-priority="4">Discount amount</th>
                        <th class="text-left" data-priority="5">Expairy date</th>
                        <th class="text-left" data-priority="5">Status</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($item->status == 'active')
                                        <a href="{{ route('backend.cupon.inactive', $item->id) }}"
                                            class="px-5 py-1 bg-green-500 rounded shadow-md text-white font-semibold uppercase">active</a>
                                    @else
                                        <a href="{{ route('backend.cupon.active', $item->id) }}"
                                            class="px-3 py-1 bg-red-500 rounded shadow-md text-white font-semibold uppercase">inactive</a>
                                    @endif
                                </td>
