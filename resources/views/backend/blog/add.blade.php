...
@section('content')
    <section>
        ...
        <h1 class="py-1 font-semibold text-3xl text-gray-600 uppercase">add blog</h1>
        <form action="{{ route('backend.blog.create') }}" method="post">
            @csrf
            <div class="lg:flex xl:flex gap-4 mt-3">
                <div class="lg:w-2/3 xl:w-2/3">
                    <div class="bg-white shadow-lg rounded p-4">
                        <div class="mb-4">
                            <label for="blog_title" class="font-semibold">Title <span class="text-red-500">*</span></label>
                            <input class="input-border rounded px-2 py-1 w-full mt-2" type="text" name="blog_title"
                                id="blog_title" required value="{{ old('blog_title') }}">
                            @error('blog_title')
                        ...
                        <div class="mb-4">
                            ...
                            <input class="input-border rounded px-2 py-1 w-full mt-2" type="text" name="blog_title_bd"
                                id="blog_title_bd" required value="{{ old('blog_title_bd') }}">
                            @error('blog_title_bd')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="input-border rounded px-2 py-1 w-full" style="margin-top: 10px;z-index: -1"
                                name="blog_description" id="editor" cols="30" rows="5"></textarea>
                        ...
                        <div class="mb-4">
                            <label for="blog_description_bd" class="font-semibold">Description in bangla<span
                                    class="text-red-500">*</span></label>
                            <textarea class="input-border rounded px-2 py-1 w-full" style="margin-top: 10px;z-index: -1"
                                name="blog_description_bd" id="editor_2" cols="30" rows="5"></textarea>
                        ...
                        <div class="w-full sssss-nav pb-4 click_post_btn cursor-pointer">
                            ...
                            <div class="w-full sssss">
                                <img class="w-full object-cover h-48 cursor-pointer" id="category-img-tag"
                                    ...
                                    alt="img">
                                <input type="hidden" value="" name="blog_image" id="news_img" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white shadow-lg rounded p-4">
