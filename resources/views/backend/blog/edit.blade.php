...
@section('content')
    <section>
        ...
        <h1 class="py-1 font-semibold text-3xl text-gray-600 uppercase">Edit blog</h1>
        <form action="{{ route('backend.blog.update') }}" method="post">
            @csrf
            @if ($blog)
                    ...
                    <div class="lg:w-2/3 xl:w-2/3">
                        <div class="bg-white shadow-lg rounded p-4">
                            <div class="mb-4">
                                ...
                                <label for="blog_title" class="font-semibold">Title <span
                                        class="text-red-500">*</span></label>
                                <input class="input-border rounded px-2 py-1 w-full mt-2" type="text" name="blog_title"
                                    id="blog_title" required value="{{ $blog->blog_title }}">
                                @error('blog_title')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-4">
                                <label for="blog_title_bd" class="font-semibold">Title in bangla<span
                                        class="text-red-500">*</span></label>
                                <input class="input-border rounded px-2 py-1 w-full mt-2" type="text" name="blog_title_bd"
                                    id="blog_title_bd" required value="{{ $blog->blog_title_bd }}">
                                @error('blog_title_bd')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="blog_description" class="font-semibold">Description<span
                                        class="text-red-500">*</span></label>
                                <textarea class="input-border rounded px-2 py-1 w-full" style="margin-top: 10px;z-index: -1"
                                    name="blog_description" id="editor" cols="30"
                            ...
                            <div class="mb-4">
                                <label for="blog_description_bd" class="font-semibold">Description in bangla<span
                                        class="text-red-500">*</span></label>
                                <textarea class="input-border rounded px-2 py-1 w-full" style="margin-top: 10px;z-index: -1"
                                    name="blog_description_bd" id="editor_2" cols="30"
                                    rows="5">{{ $blog->blog_description_bd }}</textarea>
                                @error('blog_description_bd')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="lg:w-1/3 xl:w-1/3">
                        <div class="bg-white shadow-lg rounded p-4 mb-4">
                            <div class="w-full sssss-nav pb-4 click_post_btn cursor-pointer">
                                <h1 class="text-center py-1 border-b-2 border-gray-300 font-semibold mb-1">Blog Image</h1>
                                <div class="w-full sssss">
                                    <img class="w-full object-cover h-48 cursor-pointer" id="category-img-tag"
                                        src="{{ $blog->blog_image != null ? $blog->image_path : 'https://media.sproutsocial.com/uploads/2017/02/10x-featured-social-media-image-size.png' }}"
                                        alt="img">
                                    <input type="hidden" value="{{ $blog->blog_image }}" name="blog_image" id="news_img"
                                        readonly>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-1"
                                            value="{{ $blog->meta_title }}" name="meta_title" id="meta_title">
                                        @error('meta_title')
                                            <div class="text-red-500">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-1"
                                            value="{{ $blog->meta_description }}" name="meta_description"
                                            id="meta_description">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-1"
                                            value="{{ $blog->meta_tags }}" name="meta_tags" id="meta_tags">
                                        @error('meta_tags')
                                            <div class="text-red-500">{{ $message }}</div>
                                        @enderror
                                    </div>
