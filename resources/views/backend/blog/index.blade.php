    ...
    <section class="bg-white">
        <div class="p-4 shadow-lg rounded-lg">
            <div class="flex justify-between text-white border-b-2 border_secondary pb-4 mb-4">
                <h1 class="text-3xl font-semibold text-gray-600">Blogs</h1>
                <a href="{{ route('backend.blog.add') }}"
            ...
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                <thead>
                    <tr>
                        <th class="text-left" data-priority="1">ST</th>
                        <th class="text-left" data-priority="2">Title</th>
                        <th class="text-left" data-priority="2">Blog Image</th>
                    ...
                    @if ($blog)
                        @foreach ($blog as $item)
                            <tr>
                                ...
                                <td><img class="w-10 h-10" src="{{ asset('uploads/media/' . $item->blog_image) }}"
                                        alt="">
                                </td>
                                <td>
                                    <a href="{{ route('blog.status.change', $item->id) }}"
                                ...
                                <td class="">
                                    <a href="{{ route('blog.edit', $item->id) }}"><i class="fas fa-edit"></i></a>
                                    <a href="{{ route('blog.delete', $item->id) }}"><i
