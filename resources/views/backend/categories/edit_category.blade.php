                    ...
                    <div class="lg:w-2/3 xl:w-2/3">
                        <div class="bg-white shadow-lg rounded p-4">
                            <div class="mb-4">
                                ...
                                <input class="input-border rounded px-2 py-2 w-full mt-2" type="text" name="category_title"
                                    id="category_title" required value="{{ $cat->category_title }}">
                            </div>
                            <div class="mb-4">
                                ...
                                <input class="input-border rounded px-2 py-2 w-full mt-2" type="text"
                                    name="category_title_bd" id="category_title_bd" required
                                    value="{{ $cat->category_title_bd }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="input-border rounded px-2 py-2 w-full mt-2" name="short_description"
                                    id="short_description" cols="30" rows="4">{{ $cat->short_description }}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="input-border rounded px-2 py-2 w-full" style="margin-top: 10px;z-index: -1"
                                    name="category_description" id="editor" cols="30"
                                    rows="5">{{ $cat->category_description }}</textarea>
                            </div>
                            <div class="mb-4">
                                <label for="category_description_bd" class="font-semibold">Description in bangla<span
                                        class="text-red-500">*</span></label>
                                <textarea class="input-border rounded px-2 py-2 w-full" style="margin-top: 10px;z-index: -1"
                                    name="category_description_bd" id="editor_2" cols="30"
                                    rows="5">{{ $cat->category_description_bd }}</textarea>
                            </div>
                        </div>
                    </div>
                                ...
                                <div>
                                            ...
                                            @if ($category)
                                                @foreach ($category as $item)
                                                    @if ($item->parent_category == null)
                                                        <option {{ $cat->category_title ? 'selected' : '' }}
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-2"
                                            value="{{ $cat->meta_title }}" name="meta_title" id="meta_title">
                                    </div>
                                    <div class="mt-2">
                                        <label for="meta_description">Meta description</label>
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-2"
                                            value="{{ $cat->meta_description }}" name="meta_description"
                                            id="meta_description">
                                    </div>
                                    <div class="mt-2">
                                        <label for="meta_tags">Meta tags</label>
                                        <input type="text" class="mt-2 input-border w-full rounded px-2 py-2"
                                            value="{{ $cat->meta_tags }}" name="meta_tags" id="meta_tags">
                                    </div>
                                </div>
                            </div>
