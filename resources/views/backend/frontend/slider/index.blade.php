            ...
            <div class="shadow-lg p-4 rounded bg-white">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div>
                            <input type="text" required name="slider_text_1" value="{{ old('slider_text_1') }}"
                                id="slider-text-1" class="mt-2 input-border w-full rounded px-2 py-2">
                        </div>
                        @error('slider_text_1')
                    ...
                    <div>
                        ...
                        <div>
                            <input type="text" name="slider_text_2" value="{{ old('slider_text_2') }}" id="slider-text-2"
                    ...
                    <div>
                        ...
                        <div>
                            <input type="text" name="slider_text_3" value="{{ old('slider_text_3') }}" id="slider-text-1"
                                class="mt-2 input-border w-full rounded px-2 py-2">
                        </div>
                    </div>
                </div>
                <div class="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div>
                            <input type="text" name="btn_text_1" value="{{ old('btn_text_1') }}" id="btn_text_1"
                                class="mt-2 input-border w-full rounded px-2 py-2">
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            <input type="text" name="btn_url_1" value="{{ old('btn_url_1') }}" id="btn_url_1"
                                class="mt-2 input-border w-full rounded px-2 py-2">
                        </div>
                    </div>
                </div>
                <div class="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div>
                            <input type="text" name="btn_text_2" value="{{ old('btn_text_2') }}" id="btn_text_2"
                                class="mt-2 input-border w-full rounded px-2 py-2">
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            <input type="text" name="btn_url_2" value="{{ old('btn_url_2') }}" id="btn_url_2"
                                class="mt-2 input-border w-full rounded px-2 py-2">
                        </div>
                    </div>
                </div>
                <div class="mt-4">
                    ...
                    <textarea name="slider_description" class="mt-2 input-border w-full rounded px-2 py-2" id="editor"
                        cols="30" rows="10"></textarea>
                </div>
                <div class=" sssss-nav pb-4 click_post_btn cursor-pointer w-60 mt-4">
                    <h1 class="text-center py-2 border-b-2 border-gray-300 font-semibold mb-1">Slider image <span
                        ...
                        <div class="carousel-inner relative overflow-hidden w-full">
                            @if ($slider)
                                @foreach ($slider as $key => $item)
                                    <!--Slide 1-->
                                    <input class="carousel-open" type="radio" id="carousel-{{ $key }}"
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <div class="m-2">
                                            <a href="{{ route('slider.edit', $item->id) }}"><i
                                                    data-id={{ $item->id }}
                                                    class="fas edit-slider-item fa-edit text-lg cursor-pointer"></i></a>
                                            <i data-id={{ $item->id }}
                                                class="fas delete-slider-item fa-trash text-red-500 ml-2 text-lg cursor-pointer"></i>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
