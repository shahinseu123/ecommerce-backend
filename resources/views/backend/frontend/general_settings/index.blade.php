            ...
            <div class="w-full lg:w-3/4" style="max-width: 600px">
                <div class="web-info-div p-4 bg-white shadow-lg" >
                    ...
                    <div class="">
                        ...
                        <div>
                            <input type="text" name="website_title" required value="White North Inc" id="website_title"
                            ...
                            <div>
                                <div class="w-full sssss-nav pb-4 click_post_btn cursor-pointer">
                                    ...
                                    <div class="w-full sssss">
                                        ...
                                        <input type="file" value="" name="og-image" id="og-img" >
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="div-currency hidden">
                    <div class="bg-white shadow-lg rounded p-4 mb-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="tax">Tax <span class="text-red-500">*</span></label>
                                <div>
                                    <input type="text" name="tax" required value=""
                                        id="tax" class="input-border rounded px-2 py-2 w-full mt-2">
                                </div>
                            </div>
                            <div>
                                <label for="tax_type">Currency <span class="text-red-500">*</span></label>
                                <div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                <label for="currency">Currency name <span class="text-red-500">*</span></label>
                                <div>
                                    <input type="text" name="currency" required value=""
                                        id="currency" class="input-border rounded px-2 py-2 w-full mt-2">
                                </div>
                            </div>
                            <div>
                                <label for="currency_symbol">Currency symbol<span class="text-red-500">*</span></label>
                                <div>
                                    <input type="text" name="currency_symbol" required value=""
                ...
                <div class="div-seo hidden">
                    <div class="bg-white shadow-lg rounded p-4 mb-4">                 
                            <div>
                                <label for="meta_description">Meta Description<span class="text-red-500">*</span></label>
                                <div>
                                    <input type="text" name="meta_description"  value=""
                                        id="meta_description" class="input-border rounded px-2 py-2 w-full mt-2">
                                </div>
                                <label for="keyword">Keywords<span class="text-red-500">*</span></label>
                                <div>
