            ...
            <div class=" mx-auto px-2 sm:px-6 lg:px-8">
              <div class="relative flex items-center justify-between h-16">
                <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                  <!-- Mobile menu button-->
                  <button type="button" class="mobile_menu_button_show inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  ...
                  <div class="ml-3 relative">
                    <div>
                      <button type="button" class="btn-user-options bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-expanded="false" aria-haspopup="true">
                        <span class="sr-only">Open user menu</span>
                        <img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                      </button>
                    </div>
    
                    <div class="hidden user-options-div origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
             ...
             <div class="absolute inset-0 w-full h-hull sidebar_main overflow-y-auto">
                <ul class="mt-5 px-5">
                    <li class="text-white py-1 nav_item_li cursor-pointer">
                        <span class="w-10 inline-block"><i style="color: #6366F1" class="fas fa-tachometer-alt mr-2"></i></span><a class="" style="color: #6366F1" href="">Dashboard</a>
                    </li>
                    <li class="text-white py-1 nav_item_li cursor-pointer">
                        <span class="w-10 inline-block"><i style="color: #6366F1" class="fas fa-users mr-2"></i></span><a class="" style="color: #6366F1" href="">Users</a>
                    </li>
                  ...
                  <div class="grid md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-2">
                    ...
                    <div class=" shadow-md bg-yellow-500">
                        <div class="">
                            ...
                            <p class="p-more-info px-4 py-2 border-yellow-300 bg-yellow-600 border-t-2 text-center"><a class="link-more-info"
                                    href="">More info<i class="fas fa-arrow-circle-right ml-2"></i></a></p>
                        </div>
                    </div>
                    ...
                    <div class=" shadow-md bg-green-500">
                        <div class="">
                            ...
                            <p class="p-more-info px-4 py-2 border-green-300 bg-green-600 border-t-2 text-center"><a class="link-more-info"
                                    href="">More info<i class="fas fa-arrow-circle-right ml-2"></i></a></p>
                        </div>
                    </div>
                    ...
                    <div class=" shadow-md bg-red-500">
                        <div class="">
                            ...
                            <p class="p-more-info px-4 py-2 border-red-300 bg-red-600 border-t-2 text-center"><a class="link-more-info"
                                    href="">More info<i class="fas fa-arrow-circle-right ml-2"></i></a></p>
                        </div>
                    </div>
                    <div class=" shadow-md bg-blue-500">
                        <div class="">
                            ...
                            <p class="p-more-info px-4 py-2 border-blue-300 bg-blue-600 border-t-2 text-center"><a class="link-more-info"
                                    href="">More info<i class="fas fa-arrow-circle-right ml-2"></i></a></p>
                        </div>
                    </div>
                </div>
