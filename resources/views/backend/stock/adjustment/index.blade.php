    ...
    <section class="bg-white">
        <div class="p-4 shadow-lg rounded-lg">
            <div class="flex justify-between text-white border-b-2 border_secondary pb-4 mb-4">
                <h1 class="text-3xl font-semibold text-gray-600 uppercase">Adjustment</h1>
                <a href="{{ route('backend.adjustment.add') }}"
            ...
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                <thead>
                    <tr>
                        ...
                        <th class="text-left" data-priority="2">Note</th>
                        <th class="text-left" data-priority="4">Variant ID</th>
                        <th class="text-left" data-priority="4">Purchase Price</th>
                        <th class="text-left" data-priority="4">Purchase Quantity</th>
                        ...
                        @foreach ($adjust as $item)
                            <tr>
                                ...
                                <td class="">
                                    ...
                                    <a href="{{ route('adjustment.delete', $item->id) }}"><i
