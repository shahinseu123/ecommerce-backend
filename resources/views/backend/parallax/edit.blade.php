...
@section('content')
    <section>
        ...
        <h1 class="py-2 font-semibold text-3xl text-gray-600 uppercase">edit parallax</h1>
        @if ($parallax)
            <form action="{{ route('backend.parallax.update') }}" method="post">
                @csrf
                        ...
                        <div class="bg-white shadow-lg rounded p-4">
                            <div class="mb-4">
                                ...
                                <input class="input-border rounded px-2 py-2 w-full mt-2" type="text" name="parallax_title"
                                    id="parallax_title" required value="{{ $parallax->parallax_title }}">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="input-border rounded px-2 py-2 w-full" style="margin-top: 10px;z-index: -1"
                                    ...
                                    rows="5">{{ $parallax->description }}</textarea>
                                @error('description')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="lg:w-1/3 xl:w-1/3">
                        <div class="bg-white shadow-lg rounded p-4 mb-4">
                            <div class="w-full sssss-nav pb-4 click_post_btn cursor-pointer">
                                <h1 class="text-center py-2 border-b-2 border-gray-300 font-semibold mb-1">Parallax Image
                                </h1>
                                <div class="w-full sssss">
                                    <img class="w-full object-cover h-48 cursor-pointer" id="category-img-tag"
                                        src="{{ $parallax->parallax_image ? asset('uploads/media/' . $parallax->parallax_image) : 'https://media.sproutsocial.com/uploads/2017/02/10x-featured-social-media-image-size.png' }}"
                                        alt="img">
                            ...
                            <div class=" border-gray-300">
                                <div class="mb-4">
                                    ...
                                    <input class="input-border rounded px-2 py-2 w-full mt-2" type="number"
                                        ...
                                        value="{{ $parallax->parallax_position }}">
